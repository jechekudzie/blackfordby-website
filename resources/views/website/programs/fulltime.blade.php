...
@section('content')
    ...
    Breadcumb
    ===============================-->
    <div class="breadcumb-wrapper" data-bg-src="{{ asset('assets/images/BlackfordSiteImages_Services_Banner.jpg') }}">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="content-area">
                        ...
                        <ul class="list-unstyled">
                            <li><i style="font-size: 20px;" class="fas fa-check-circle text-theme"></i> One year of industrial attachment for practical experience.</li>
                            <li><i style="font-size: 20px;" class="fas fa-check-circle text-theme"></i> Specialized training in both crop and livestock production.</li>
                            <li><i style="font-size: 20px;" class="fas fa-check-circle text-theme"></i> Access to modern farm facilities and expert instructors.</li>
                        </ul>
                ...
                <div class="col-lg-6 text-center">
                    <div class="image-area">
                        <img src="{{ asset('assets/images/BlackfordSiteImages_Diploma_full.jpg') }}" alt="Full-Time Program" class="img-fluid shadow rounded">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4 mt-4">
                <div class="col-md-6 col-lg-4">
                    <div class="feature-box">
                        <i style="font-size: 30px;" class="fas fa-tractor text-theme"></i>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="feature-box">
                        <i style="font-size: 30px;" class="fas fa-seedling text-theme"></i>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="feature-box">
                        <i style="font-size: 30px;" class="fas fa-paw text-theme"></i>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="feature-box">
                        <i style="font-size: 30px;" class="fas fa-chart-line text-theme"></i>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="feature-box">
                        <i style="font-size: 30px;" class="fas fa-tools text-theme"></i>
    ...
    <section class="apply-layout1 space" data-bg-src="{{ asset('assets/img/bg/apply-bg.jpg') }}">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="apply-img">
                        <img src="{{ asset('assets/images/BlackfordSiteImages_applying.jpg') }}" alt="How to Apply" class="img-fluid rounded shadow">
                    </div>
                </div>
            </div>
        </div>
