            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="content-area">
                        ...
                        <ul class="list-unstyled">
                            <li><i style="font-size: 20px;" class="fas fa-check-circle text-theme"></i> Flexible scheduling with online and weekend practical sessions.</li>
                            <li><i style="font-size: 20px;" class="fas fa-check-circle text-theme"></i> Industry-relevant curriculum tailored for immediate application.</li>
                            <li><i style="font-size: 20px;" class="fas fa-check-circle text-theme"></i> Accessible learning via Google Classroom, WhatsApp, and face-to-face sessions.</li>
                        </ul>
                ...
                <div class="col-lg-6 text-center">
                    <div class="image-area">
                        <img src="{{ asset('assets/images/BlackfordSiteImages_Diplomashort.jpg') }}" alt="Part-Time Program" class="img-fluid shadow rounded">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4 mt-4">
                <div class="col-md-6 col-lg-4">
                    <div class="feature-box">
                        <i style="font-size: 30px;" class="fas fa-calendar-alt text-theme"></i>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="feature-box">
                        <i style="font-size: 30px;" class="fas fa-laptop text-theme"></i>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="feature-box">
                        <i style="font-size: 30px;" class="fas fa-user-check text-theme"></i>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="feature-box">
                        <i style="font-size: 30px;" class="fas fa-user-graduate text-theme"></i>
